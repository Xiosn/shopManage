<template>
  <div>
    <!-- 面包屑导航 -->
    <my-bread bread="商品管理" bread2="添加商品" />
      ...
      >
        ...
        >
          ...
          <el-tab-pane label="商品内容" name="4">
            ...
            <el-button @click="addProduct" class="btn-add" type="primary">添加商品</el-button>
          </el-tab-pane>
        </el-tabs>
      </el-form>
    </el-card>
...
import { getAllGoodsRequest, addGoodsDataRequest } from "network/goods";
  ...
  methods: {
    ...
    addProduct() {
      this.$refs.addFormRef.validate(async valid => {
        ...
        // 执行添加业务逻辑 对this.addForm进行深拷贝 调用lodash的cloneDeep()方法
        ...
        const res = await addGoodsDataRequest(form);
        console.log(res);
